...
class PostgreSqlSchemaContributorTest {
    ...
    void createCommandsContainPostgisIndexesAndSecurityObjects() {
        ...
        assertThat(ddl)
                ...
                .contains("ON ho_so_thanh_vien (nguoi_dung_id, nha_truong_id)")
                .contains("('DRAFT','SUBMITTED','UNDER_REVIEW','NEED_SUPPLEMENT','APPROVED','SUSPENDED')")
                .doesNotContain("ON ho_so_thanh_vien (nguoi_dung_id, nha_truong_id, loai_ho_so)")
                .contains("CREATE UNIQUE INDEX IF NOT EXISTS uk_bang_chung_thanh_vien_current_slot")
                .contains("ON bang_chung_thanh_vien (ho_so_thanh_vien_id, slot)")
                .contains("CREATE INDEX IF NOT EXISTS idx_ho_so_sinh_vien_ma_so_normalized")
                .contains("upper(ma_so_sinh_vien)")
    ...
    void dropCommandsAreSafeAfterAnInterruptedSchemaCreation() {
        ...
        assertThat(ddl)
                ...
                .contains("DROP INDEX IF EXISTS uk_ho_so_thanh_vien_hien_hanh")
                .contains("DROP INDEX IF EXISTS uk_bang_chung_thanh_vien_current_slot")
                .contains("DROP INDEX IF EXISTS idx_ho_so_sinh_vien_ma_so_normalized")
