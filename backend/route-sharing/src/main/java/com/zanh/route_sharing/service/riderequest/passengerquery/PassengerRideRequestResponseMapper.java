...
public class PassengerRideRequestResponseMapper {
    ...
    public PassengerRideRequestDetailResponse toDetail(
        ...
        PassengerRideRequestDetailResponse.StoredRoute originalRoute =
                new PassengerRideRequestDetailResponse.StoredRoute(
        ...
        PassengerRideRequestDetailResponse.StoredRoute passengerRoute =
                new PassengerRideRequestDetailResponse.StoredRoute(
                        ...
                        null);
        PassengerRideRequestDetailResponse.StoredRoute servedSegment =
                new PassengerRideRequestDetailResponse.StoredRoute(
        ...
        PassengerRideRequestDetailResponse.RouteContext routeContext =
                new PassengerRideRequestDetailResponse.RouteContext(
                        route.routeId(),
                        route.status(),
        ...
        PassengerRideRequestDetailResponse.Driver driver =
                new PassengerRideRequestDetailResponse.Driver(
                        row.driver().driverId(),
                        row.driver().fullName(),
                        row.driver().avatarUrl());

        PassengerRideRequestDetailResponse.Vehicle vehicle =
                new PassengerRideRequestDetailResponse.Vehicle(
        ...
        PassengerRideRequestDetailResponse.BookingSnapshot bookingSnapshot =
                new PassengerRideRequestDetailResponse.BookingSnapshot(
                        booking.matchType(),
                        booking.dropoffType(),
                        pickup,
        ...
        PassengerRideRequestDetailResponse.StoredMap map =
                new PassengerRideRequestDetailResponse.StoredMap(
                        originalRoute,
                        passengerRoute,
                        servedSegment,
                        List.of(
