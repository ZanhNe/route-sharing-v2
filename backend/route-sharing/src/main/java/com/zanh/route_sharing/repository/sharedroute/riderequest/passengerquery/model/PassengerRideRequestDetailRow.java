...
public record PassengerRideRequestDetailRow(
        ...
        public PassengerRideRequestDetailRow(
                        Long rideRequestId, TrangThaiYeuCau status, Instant sentAt, Instant acceptedAt,
                        Instant rejectedAt, Instant cooldownUntil, Instant cancelledAt, String cancellationReason,
                        boolean assignedToTrip, RouteRow route, DriverRow driver, VehicleRow vehicle,
                        BookingRow booking) {
                this(rideRequestId, status, sentAt, acceptedAt, rejectedAt, cooldownUntil, cancelledAt,
                                cancellationReason, assignedToTrip, null, route, driver, vehicle, booking);
        }
